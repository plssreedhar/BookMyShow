...
import com.scaler.bookmyshow.controllers.ShowController;
...
public class TestShowController {
    ...
    public void testCreateShow_Success(){
        ...
        showSeats.forEach(showSeat -> assertEquals(ShowSeatStatus.AVAILABLE, showSeat.getShowSeatStatus(), "Show seat status should be available"));
